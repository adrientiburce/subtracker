export default function Navigation({ currentScreen, onDashboard, onAdd, onAnalysis, onSettings }) {
  ...
  return (
    <>
      ...
      <nav className="lg:hidden fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 px-4 pb-6 pt-3 flex items-center justify-around">
        {navItems.map(item => (
          <button
            key={item.id}
