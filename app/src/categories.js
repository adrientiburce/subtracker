export const CATEGORIES = [
  ...
  { id: 'health', label: 'Health & Wellness', icon: 'medical_services', bg: 'bg-pink-100', text: 'text-pink-600', border: 'border-pink-200', sectionBg: 'bg-pink-50' },
  { id: 'music', label: 'Music & Audio', icon: 'music_note', bg: 'bg-purple-100', text: 'text-purple-600', border: 'border-purple-200', sectionBg: 'bg-purple-50' },
  { id: 'food', label: 'Food & Delivery', icon: 'restaurant', bg: 'bg-orange-100', text: 'text-orange-600', border: 'border-orange-200', sectionBg: 'bg-orange-50' },
  { id: 'productivity', label: 'Productivity', icon: 'work', bg: 'bg-indigo-100', text: 'text-indigo-600', border: 'border-indigo-200', sectionBg: 'bg-indigo-50' },
